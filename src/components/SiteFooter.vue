...
<template>
  <footer class="bg-slate-950 text-white relative overflow-hidden" id="contact">
    ...
    <div class="relative">
      <!-- Main Footer Content -->
      <div class="mx-auto container px-4 sm:px-6 lg:px-8 py-16 lg:py-20">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12">
          <!-- Brand Column -->
          <div class="lg:col-span-4">
            <div class="flex items-center gap-3 mb-6">
              <div class="h-12 w-12 rounded-xl bg-gradient-to-br from-brand-500 to-emerald-500 flex items-center justify-center text-white font-bold shadow-lg">
            ...
            <div class="flex items-center gap-3">
              <a 
                ...
                class="h-10 w-10 rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 hover:border-brand-400 flex items-center justify-center transition-all group hover:scale-110"
              >
                <svg class="w-5 h-5 text-white/70 group-hover:text-brand-400 transition-colors" fill="currentColor" viewBox="0 0 24 24">
                  <path :d="social.icon" />
                </svg>
              </a>
            </div>
        ...
        <div class="mx-auto container px-4 sm:px-6 lg:px-8 py-6">
          <div class="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-6 text-sm">
              ...
              <a href="#terms" class="text-white/60 hover:text-brand-400 transition-colors">Terms</a>
              <a href="#cookies" class="text-white/60 hover:text-brand-400 transition-colors">Cookies</a>
            </div>
          </div>
      </div>
      </div>
