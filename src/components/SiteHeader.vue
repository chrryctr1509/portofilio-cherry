    ...
    <div class="mx-auto container px-4 sm:px-6 lg:px-8">
      <div class="flex items-center justify-between h-20">
        ...
        <div class="hidden lg:flex items-center gap-3">
          <button class="px-5 py-2.5 text-sm font-semibold text-slate-700 rounded-lg border-2 border-slate-200 hover:border-slate-300 hover:bg-slate-50 transition-all">
            Sign In
          </button>
          <button class="px-6 py-2.5 text-sm font-bold text-white rounded-lg bg-gradient-to-r from-brand-500 via-emerald-500 to-teal-500 shadow-lg hover:shadow-xl hover:scale-105 transition-all">
            Start Project
          </button>
        </div>
      ...
      >
        <div v-if="mobileMenuOpen" class="lg:hidden pb-6 pt-2">
          ...
          <div class="flex flex-col gap-3 mt-4 pt-4 border-t border-slate-200">
            <button class="px-4 py-3 text-sm font-semibold text-slate-700 rounded-lg border-2 border-slate-200 hover:bg-slate-50 transition-all">
              Sign In
            </button>
            <button class="px-4 py-3 text-sm font-bold text-white rounded-lg bg-gradient-to-r from-brand-500 to-emerald-500 shadow-lg">
              Start Project
            </button>
          </div>
        </div>
